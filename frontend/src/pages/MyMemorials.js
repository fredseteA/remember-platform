...
const MyMemorials = () => {
  ...
  const [deleteModal, setDeleteModal] = useState(null); // memorial object
    ...
    <>
      ...
      >
        <style>{`
          ...
          .mm-btn-outline {
            display: inline-flex; align-items: center; justify-content: center; gap: 7px;
            padding: 10px 18px; border-radius: 999px; background: transparent; color: #2a3d5e;
          ...
          .mm-btn-danger {
            ...
            transition: all 0.25s ease; min-height: 40px; -webkit-tap-highlight-color: transparent;
          }
          .mm-btn-danger:hover {
            background: rgba(239,68,68,0.13); border-color: rgba(239,68,68,0.4);
          }
          @media (max-width: 480px) {
            .mm-header { flex-direction: column !important; align-items: flex-start !important; gap: 16px !important; }
            .mm-card-actions { flex-wrap: wrap !important; }
            .mm-card-actions a { flex: 1 1 45% !important; }
